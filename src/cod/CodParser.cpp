...
{
    MDCII_LOG_DEBUG("[CodParser::~CodParser()] Destruct CodParser.");
}
...
bool mdcii::cod::CodParser::ReadFile(const bool t_decode)
{
    ...
    if (t_decode)
    {
        MDCII_LOG_DEBUG("[CodParser::ReadFile()] Start decoding {}...", m_path);
        ...
        MDCII_LOG_DEBUG("[CodParser::ReadFile()] Cod file successfully decoded.");
    }

    MDCII_LOG_DEBUG("[CodParser::ReadFile()] Start reading in decoded data...");
    ...
    MDCII_LOG_DEBUG("[CodParser::ReadFile()] Decoded data read successfully.");
...
void mdcii::cod::CodParser::ParseFile()
{
    ...
    MDCII_LOG_DEBUG("[CodParser::ParseFile()] Start creating Cod objects...");
    ...
    MDCII_LOG_DEBUG("[CodParser::ParseFile()] Cod objects created successfully.");
...
{
    MDCII_LOG_DEBUG("[CodParser::Json()] Start building the {}...", m_jsonPath);
    ...
    {
        MDCII_LOG_DEBUG("[CodParser::Json()] Successfully converted Protobuf to Json.");
    }
    else
    {
    ...
    MDCII_LOG_DEBUG("[CodParser::Json()] The Json file was created successfully.");
}

void mdcii::cod::CodParser::Deserialize()
{
    MDCII_LOG_DEBUG("[CodParser::Deserialize()] Start reading the {}...", m_jsonPath);
    ...
    {
        MDCII_LOG_DEBUG("[CodParser::Deserialize()] Successfully converted Json to Protobuf.");
    }
    else
    {
    ...
    MDCII_LOG_DEBUG("[CodParser::Deserialize()] The Json file was readed successfully.");
}
