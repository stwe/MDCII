...
{
    /**
     * @brief Forward declaration class Chunk.
     */
    class Chunk;
}
...
namespace mdcii::resource
{
    ...
    /**
     * @brief Common stuff for all BinaryFile objects.
     */
    class BinaryFile
    {
    public:
        ...
        /**
         * @brief Each file has one or many Chunk objects.
         */
        ...
        /**
         * @brief Constructs a new BinaryFile object from a given path.
         *
        ...
        /**
         * @brief Opens and reads the file.
         *
